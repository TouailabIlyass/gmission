...
public class VehiculeSprinnerAdapter extends BaseAdapter implements SpinnerAdapter {

    ArrayList<Employe> list;
    Context context;

    public VehiculeSprinnerAdapter(Context context, ArrayList<Employe> list) {
        this.list = list;
