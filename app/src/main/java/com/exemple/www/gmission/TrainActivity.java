...
public class TrainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        valider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getStock(Double.valueOf(prix.getText().toString()),new Train(0,numbon.getText().toString(),prix.getText().toString(),null,destination.getText().toString(),listempcin.getText().toString()));
            }
        });
        jsonArrayParse();
    }
    public void addTransport(Train train){
        ...
        try {
            json.put("id",0);
            json.put("numBon",train.getNumBon());
            json.put("prix",train.getPrix());
            json.put("date",train.getDate());
            json.put("destination",train.getDestination());
            json.put("accompagne",train.getAccompagne());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        String url = Res.URL+"/train.php?cin="+Res.getEmploye().getCin();
    ...
    private void getStock(final double prix,final Train train)
    {
        RequestQueue mRequestQueue;
        mRequestQueue = Volley.newRequestQueue(getApplicationContext());
